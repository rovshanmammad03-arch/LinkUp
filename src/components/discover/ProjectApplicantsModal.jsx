        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="bg-white dark:bg-[#0a0a0a] border border-black/10 dark:border-white/10 rounded-[32px] p-8 max-w-xl w-full relative z-10 anim-up flex flex-col shadow-2xl overflow-y-auto max-h-[90vh]">
                <div className="flex items-center justify-between mb-8 pb-4 border-b border-black/8 dark:border-white/5">
                    <div>
                        <h3 className="text-2xl font-bold text-neutral-900 dark:text-white leading-tight">Müraciətlər</h3>
                ...
                <div className="space-y-4">
                    {applicants.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-neutral-400 dark:text-neutral-500 text-sm">Hələ ki, heç kim müraciət etməyib.</p>
                        </div>
                    ) : (
                        applicants.map((u, i) => (
                            <div key={u.id} className="flex items-center justify-between p-4 bg-black/5 dark:bg-white/5 border border-black/8 dark:border-white/5 rounded-2xl group hover:border-black/15 dark:hover:border-white/10 transition-all shadow-sm" style={{ animationDelay: `${i * 0.05}s` }}>
                                ...
                                <div className="flex items-center gap-2">
                                    <button 
                                        ...
                                        className="w-10 h-10 flex items-center justify-center bg-brand-500/10 text-brand-500 rounded-xl hover:bg-brand-500 hover:text-white transition-all active:scale-95"
                                        title="Mesaj Göndər"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className="w-10 h-10 flex items-center justify-center bg-black/5 dark:bg-white/5 text-neutral-600 dark:text-white rounded-xl hover:bg-black/10 dark:hover:bg-white/10 transition-all active:scale-95"
                                        title="Profilə Bax"
                                    >
